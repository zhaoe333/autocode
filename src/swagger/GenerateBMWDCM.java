...
public class GenerateBMWDCM {
    private static final Logger log = LoggerFactory.getLogger(GenerateBMWDCM.class);

    private static final String jdbc_url = "jdbc:mysql://10.0.0.24:3306/bmw_mvp?rewriteBatchedStatements=true&useUnicode=true&characterEncoding=utf8";

    private static final String user_name = "root"; //jdbc连接用户名

    private static final String user_password = "123456"; //jdbc连接密码

    private static final String tableNamePrefix="dcm_";

    private static final String basePackagePath = "com.cm";
    //生成代码文件夹
    private static final String basePath = "C:\\files\\myswagger\\";
    //数据库名称
    private static final String dbName = "bmw_mvp";
    //生成文件编码
    private static String fileEncoding = "UTF-8";
    //模板文件路径
    private static String baseTemplatePath = "bmw_dcm";
    //作者（生成Class文件注解的作者信息）
    ...
    public static void main(String[] args) throws Exception{
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(!table.getTableName().contains("dcm")) {
                    continue;
                }
    ...
    private static Map<String,String> build(TemplateTable table) throws Exception{
        ...
        for(TemplateColumn column:columns){
            if(column.getUnique()==0){
                ...
                if(!column.getName().equals("id")){
                    ...
                    map.put("idType", JavaType.preferredJavaTypeToSqlType.get(column.getType()));
                }
            }
        ...
        map.put("updateNames", "$"+ StringUtil.join(updateNames));
