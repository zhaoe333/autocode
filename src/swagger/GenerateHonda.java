...
public class GenerateHonda {
	...
	//生成代码文件夹
	private static final String basePath = "/home/zyl/Documents/myswagger/";
	//数据库名称
	private static final String dbName = "honda_com";
	//生成文件编码
	private static String fileEncoding = "UTF-8";
	//模板文件路径
	private static String baseTemplatePath = "honda";
	//作者（生成Class文件注解的作者信息）
	...
	public static void main(String[] args) throws Exception{
		...
		try{
			...
			while(rs.next()){
				...
				if(!table.getTableName().contains("honda")) {
					continue;
				}
